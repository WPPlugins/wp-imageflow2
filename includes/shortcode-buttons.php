			...
			<div class="wpif2_sc_section wpif2_general">
				...
				<div>
					...
					<select id="wpif2_sc_carousel" />
						...
						<option value="midline" <?php echo $disabled; ?>><?php _e('Top Aligned', 'wp-imageflow2'); ?></option>
						<option value="topline"<?php echo $disabled; ?>><?php _e('Vertical Centered', 'wp-imageflow2'); ?></option>
